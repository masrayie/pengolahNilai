...
<div class="main">
	...
	<div class="main-content">
		<div class="container-fluid">
			<!-- OVERVIEW -->
			<h3 class="page-title">Tambah Pegawai Baru</h3>
			<div class="row">
				<div class="col-md-6">
					<!-- BUTTONS -->
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Form Tambah Pegawai</h3>
						</div>
						<div class="panel-body">
							<form action="<?php echo base_url('index.php/Pegawai/store');?>" method="POST">
