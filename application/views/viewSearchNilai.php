...
<div class="main">
	...
	<div class="main-content">
		<div class="container-fluid">
			<!-- OVERVIEW -->
			<h3 class="page-title">Pencarian Nilai Kelas</h3>
			<div class="row">
				<div class="col-md-6">
					<!-- BUTTONS -->
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Form Pencarian Nilai</h3>
						</div>
						<div class="panel-body">
							<form action="<?php echo base_url('index.php/Nilai/nilaiKelas/')?>" method="GET">
								<div class="form-group">
									<label class="control-label ">Kelas</label>
									<select class="form-control" name="id_kelas">
										<option value="#">Pilih Kelas</option>
										<?php
											for($i=0;$i<sizeof($objKelas);$i++) {
										?>
										<option value="<?php echo $objKelas[$i]['id_kelas'];?>">
										<?php echo 'Kelas '.$objKelas[$i]['nama_kelas'];?>
										</option>
											<?php } ?>
									</select>
								</div>
